...
class PathData {
 ...
 private:
  ...
  DiscretizedPath discretized_path_;  // s,x,y,theta,kappa,dkappa,ddkappa
  FrenetFramePath frenet_path_;       // s,l,dl,ddl
   ...
   *
   */
  // wheter this PathData is a path reference serving as an optimization target for later modules
